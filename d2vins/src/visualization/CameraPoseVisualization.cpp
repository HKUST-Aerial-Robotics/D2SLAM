...
CameraPoseVisualization::CameraPoseVisualization(Eigen::Vector3d rgb, float a)
    : m_marker_ns("CameraPoseVisualization"), m_scale(0.2), m_line_width(0.01) {
    m_image_boundary_color.r = rgb.x();
    m_image_boundary_color.g = rgb.y();
    m_image_boundary_color.b = rgb.z();
    m_image_boundary_color.a = a;
    m_optical_center_connector_color.r = rgb.x();
    m_optical_center_connector_color.g = rgb.y();
    m_optical_center_connector_color.b = rgb.z();
...
void CameraPoseVisualization::addPose(const Eigen::Vector3d& p, const Eigen::Quaterniond& q, const Eigen::Vector3d& color, double alpha) {
    visualization_msgs::Marker marker;
    ...
    marker.points.push_back(pt_lt);
    marker.points.push_back(pt_lb);
    marker.colors.push_back(m_color);
    marker.colors.push_back(m_color);
...
void CameraPoseVisualization::publishBy( ros::Publisher &pub, const std_msgs::Header &header ) {
